        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <div class="d-flex">
                        <div class="me-auto"><h4>All Mcqs Category</h4></div>
                        <div class="">
                                    ...
                                    <td class="d-flex">                                      
                                        ...
                                        <div class="btn-group">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-md p-4" style="width: 310px;">
                                                <form action="{{ route('mcqs-category.update',[$value->id]) }}" method="POST">
                                                    @csrf
                                                    @method('PUT')
                                        ...
                                        <form class="deleteMcqCategoryForm" method="POST" action="javascript:void(0)">
                                            @csrf 
                                            @method('DELETE')
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="mcqsCategoryModalLabel">Create Mcqs Category</h1>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form action="{{ route('mcqs-category.store') }}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="row mb-3">
                            <div class="col-lg-12">                            
...
@push('script')
    <script>
         ...
         */
        $(document).on('click', '.deleteMcqCategoryForm button', function (e) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        url: base_url+'/mcqs_category/' + jobId, 
                        type: 'DELETE',
                        headers: {
                        ...
                        success: function(response) {                       
                            ...
                            setTimeout(() => {
                                window.location.href = base_url + "/mcqs_category";
                            }, 1200);   
                        },
