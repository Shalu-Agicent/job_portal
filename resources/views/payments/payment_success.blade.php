...
<html lang="en">
    <head>
        <meta charset="utf-8" />
        <title>Job Portal | Payment Successful</title>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center mb-3">                           
                            <h4 class="text-uppercase">Your payment has been processed successfully.</h4>
                ...
                <div class="row justify-content-center">
                    <div class="col-md-10 col-xl-8">
                        <div>
                            <img src="{{ url('public') }}/assets/images/payment-success.png" alt="" class="img-fluid">
                        </div>
                    </div>
                    <!-- end row -->
                </div>
